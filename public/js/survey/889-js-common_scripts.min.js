! function(t, e) {
    ...
    function f(t, e, i, s) {
        var n, o, r, a, l, h, c, u = {
            ...
            d = C(t, e);
        if ("viewport" === s) n = d, o = window.document.documentElement, r = S(n, o), a = N(o.clientWidth, window.innerWidth || 0), l = N(o.clientHeight, window.innerHeight || 0), h = D(o), c = D(o, "left"), u = k({
            ...
            return t.reduce(function(t, e) {
                ...
                return function(t, e, i, s) {
                    var n, o = t.match(/((?:\-|\+)?\d*\.?\d*)(.*)/),
                        ...
                        a = o[2];
                    if (!r) return t;
                    if (0 !== a.indexOf("%")) return "vh" !== a && "vw" !== a ? r : ("vh" === a ? N(document.documentElement.clientHeight, window.innerHeight || 0) : N(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * r;
                    switch (a) {
                        case "%p":
                            n = i;
                            break;
    ...
    var R, $, j = O && ($ = window.MutationObserver, r.some(function(t) {
    ...
    function G(t, e) {
        ...
        }, this.update = j(this.update.bind(this)), this.options = Y({}, G.Defaults, s), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = t.jquery ? t[0] : t, this.popper = e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(Y({}, G.Defaults.modifiers, s.modifiers)).forEach(function(t) {
            ...
            offset: {
                ...
                fn: function(t, e) {
                    var i, s = e.offset,
                        ...
                        a = o.reference,
                        l = n.split("-")[0];
                    return i = d(+s) ? [+s, 0] : m(s, r, a, l), "left" === l ? (r.top += i[0], r.left -= i[1]) : "right" === l ? (r.top += i[0], r.left += i[1]) : "top" === l ? (r.left += i[0], r.top -= i[1]) : "bottom" === l && (r.left += i[0], r.top += i[1]), t.popper = r, t
                },
                offset: 0
            },
            preventOverflow: {
            ...
            flip: {
                ...
                fn: function(p, g) {
                    ...
                    return y.forEach(function(t, e) {
                        ...
                        (r || u || f) && (p.flipped = !0, (r || u) && (v = y[e + 1]), f && (b = "end" === (i = b) ? "start" : "start" === i ? "end" : i), p.placement = v + (b ? "-" + b : ""), p.offsets.popper = Y({}, p.offsets.popper, T(p.instance.popper, p.offsets.reference, p.placement)), p = P(p.instance.modifiers, p, "flip"))
                    }), p
                },
                behavior: "flip",
                padding: 5,
...
function(t, e) {
        ...
        typeCheckConfig: function(t, e, i) {
            for (var s in i)
                if (Object.prototype.hasOwnProperty.call(i, s)) {
                    var n = i[s],
                        o = e[s],
                        r = o && h.isElement(o) ? "element" : (a = o, {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase());
                    if (!new RegExp(n).test(r)) throw new Error(t.toUpperCase() + ': Option "' + s + '" provided type "' + r + '" but expected type "' + n + '".')
                }
            var a
        }
    }, (n = e).fn.emulateTransitionEnd = o, n.event.special[h.TRANSITION_END] = {
        bindType: i,
        delegateType: i,
        handle: function(t) {
    ...
    var a, u, d, p, g, m, v, _, b, y, w, C, D, x, k, I, S, E, T, A, P, F, M, N, O, z, H, L, W, R, $, j, q, B, Y, U, K, Q, V, X, Z, G, J, tt, et, it, st, nt, ot, rt, at, lt, ht, ct, ut, dt, ft, pt, gt, mt, vt, _t, bt, yt, wt, Ct, Dt, xt, kt, It, St, Et, Tt, At, Pt, Ft, Mt, Nt, Ot, zt, Ht, Lt, Wt, Rt, $t, jt, qt, Bt, Yt, Ut, Kt, Qt, Vt, Xt, Zt, Gt, Jt, te, ee, ie, se, ne, oe, re, ae, le, he, ce, ue, de, fe, pe, ge, me, ve, _e, be, ye, we, Ce, De, xe, ke, Ie, Se, Ee, Te, Ae, Pe, Fe, Me, Ne, Oe, ze, He, Le, We, Re, $e, je, qe, Be, Ye, Ue, Ke, Qe, Ve, Xe, Ze, Ge, Je, ti, ei, ii, si, ni, oi, ri, ai, li, hi, ci, ui, di, fi, pi, gi, mi, vi, _i, bi, yi, wi, Ci, Di, xi, ki, Ii, Si, Ei, Ti, Ai, Pi, Fi, Mi, Ni, Oi, zi, Hi, Li, Wi, Ri, $i, ji, qi, Bi, Yi = (u = "alert", p = "." + (d = "bs.alert"), g = (a = e).fn[u], m = {
        ...
        }(), a(document).on(m.CLICK_DATA_API, '[data-dismiss="alert"]', y._handleDismiss(new y)), a.fn[u] = y._jQueryInterface, a.fn[u].Constructor = y, a.fn[u].noConflict = function() {
            return a.fn[u] = g, y._jQueryInterface
        }, y),
        Ui = (C = "button", x = "." + (D = "bs.button"), k = ".data-api", I = (w = e).fn[C], S = "active", E = "btn", A = '[data-toggle^="button"]', P = '[data-toggle="buttons"]', F = "input", M = ".active", N = ".btn", O = {
            CLICK_DATA_API: "click" + x + k,
            FOCUS_BLUR_DATA_API: (T = "focus") + x + k + " blur" + x + k
        }, z = function() {
            function i(t) {
                this._element = t
            }
        ...
        }(), w(document).on(O.CLICK_DATA_API, A, function(t) {
            t.preventDefault();
            var e = t.target;
        ...
        }), w.fn[C] = z._jQueryInterface, w.fn[C].Constructor = z, w.fn[C].noConflict = function() {
            return w.fn[C] = I, z._jQueryInterface
        }, z),
        Ki = (L = "carousel", R = "." + (W = "bs.carousel"), $ = ".data-api", j = (H = e).fn[L], q = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            wrap: "boolean"
        }, Y = "next", U = "prev", K = "left", Q = "right", V = {
            SLIDE: "slide" + R,
            SLID: "slid" + R,
            KEYDOWN: "keydown" + R,
            ...
            TOUCHEND: "touchend" + R,
            LOAD_DATA_API: "load" + R + $,
            CLICK_DATA_API: "click" + R + $
        }, X = "carousel", Z = "active", G = "slide", J = "carousel-item-right", tt = "carousel-item-left", et = "carousel-item-next", it = "carousel-item-prev", st = ".active", nt = ".active.carousel-item", ot = ".carousel-item", rt = ".carousel-item-next, .carousel-item-prev", at = ".carousel-indicators", lt = "[data-slide], [data-slide-to]", ht = '[data-ride="carousel"]', ct = function() {
            function o(t, e) {
            ...
            return t.next = function() {
                ...
                H(this._element).off(R), H.removeData(this._element, W), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                ...
                if (n = t === Y ? (i = tt, s = et, K) : (i = J, s = it, Q), l && H(l).hasClass(Z)) this._isSliding = !1;
                    ...
                    if (H(this._element).hasClass(G)) {
                        ...
                        H(r).one(f.TRANSITION_END, function() {
                            H(l).removeClass(i + " " + s).addClass(Z), H(r).removeClass(Z + " " + s + " " + i), o._isSliding = !1, setTimeout(function() {
        ...
        }(), H(document).on(V.CLICK_DATA_API, lt, ct._dataApiClickHandler), H(window).on(V.LOAD_DATA_API, function() {
            for (var t = [].slice.call(document.querySelectorAll(ht)), e = 0, i = t.length; e < i; e++) {
                var s = H(t[e]);
                ct._jQueryInterface.call(s, s.data())
            }
        }), H.fn[L] = ct._jQueryInterface, H.fn[L].Constructor = ct, H.fn[L].noConflict = function() {
            return H.fn[L] = j, ct._jQueryInterface
        }, ct),
        Qi = (dt = "collapse", pt = "." + (ft = "bs.collapse"), gt = (ut = e).fn[dt], mt = {
            toggle: !0,
            parent: ""
        }, vt = {
            toggle: "boolean",
        ...
        }, bt = "show", yt = "collapse", wt = "collapsing", Ct = "collapsed", Dt = "width", xt = "height", kt = ".show, .collapsing", It = '[data-toggle="collapse"]', St = function() {
            function a(e, t) {
                this._isTransitioning = !1, this._element = e, this._config = this._getConfig(t), this._triggerArray = ut.makeArray(document.querySelectorAll('[data-toggle="collapse"][href="#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]'));
            ...
            return t.toggle = function() {
                ...
                var t, e, i = this;
                if (!this._isTransitioning && !ut(this._element).hasClass(bt) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(kt)).filter(function(t) {
                        return t.getAttribute("data-parent") === i._config.parent
                    })).length && (t = null), !(t && (e = ut(t).not(this._selector).data(ft)) && e._isTransitioning))) {
                    ...
                    if (ut(this._element).trigger(s), !s.isDefaultPrevented()) {
                        ...
                        ut(this._element).one(f.TRANSITION_END, function() {
        ...
        }), ut.fn[dt] = St._jQueryInterface, ut.fn[dt].Constructor = St, ut.fn[dt].noConflict = function() {
            return ut.fn[dt] = gt, St._jQueryInterface
        }, St),
        Vi = (Tt = "dropdown", Pt = "." + (At = "bs.dropdown"), Ft = ".data-api", Mt = (Et = e).fn[Tt], Nt = new RegExp("38|40|27"), Ot = {
            HIDE: "hide" + Pt,
            HIDDEN: "hidden" + Pt,
            SHOW: "show" + Pt,
            SHOWN: "shown" + Pt,
            ...
            KEYDOWN_DATA_API: "keydown" + Pt + Ft,
            KEYUP_DATA_API: "keyup" + Pt + Ft
        }, zt = "disabled", Ht = "show", Lt = "dropup", Wt = "dropright", Rt = "dropleft", $t = "dropdown-menu-right", jt = "position-static", qt = '[data-toggle="dropdown"]', Bt = ".dropdown form", Yt = ".dropdown-menu", Ut = ".navbar-nav", Kt = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Qt = "top-start", Vt = "top-end", Xt = "bottom-start", Zt = "bottom-end", Gt = "right-start", Jt = "left-start", te = {
            offset: 0,
            flip: !0,
            ...
            return t.toggle = function() {
                    ...
                    if (h._clearMenus(), !e) {
                        ...
                        if (Et(t).trigger(s), !s.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var n = this._element;
                                "parent" === this._config.reference ? n = t : f.isElement(this._config.reference) && (n = this._config.reference, void 0 !== this._config.reference.jquery && (n = this._config.reference[0])), "scrollParent" !== this._config.boundary && Et(t).addClass(jt), this._popper = new c(n, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === Et(t).closest(Ut).length && Et(document.body).children().on("mouseover", null, Et.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), Et(this._menu).toggleClass(Ht), Et(t).toggleClass(Ht).trigger(Et.Event(Ot.SHOWN, i))
                        }
                    }
                }
            }, t.dispose = function() {
                    ...
                    for (var e = [].slice.call(document.querySelectorAll(qt)), i = 0, s = e.length; i < s; i++) {
                        ...
                        if (t && "click" === t.type && (r.clickEvent = t), o) {
                            ...
                            if (Et(n).hasClass(Ht) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && Et.contains(n, t.target))) {
                                ...
                                Et(n).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && Et(document.body).children().off("mouseover", null, Et.noop), e[i].setAttribute("aria-expanded", "false"), Et(a).removeClass(Ht), Et(n).removeClass(Ht).trigger(Et.Event(Ot.HIDDEN, r)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || Et(t.target).closest(Yt).length)) : Nt.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !Et(this).hasClass(zt))) {
        ...
        }(), Et(document).on(Ot.KEYDOWN_DATA_API, qt, ie._dataApiKeydownHandler).on(Ot.KEYDOWN_DATA_API, Yt, ie._dataApiKeydownHandler).on(Ot.CLICK_DATA_API + " " + Ot.KEYUP_DATA_API, ie._clearMenus).on(Ot.CLICK_DATA_API, qt, function(t) {
            t.preventDefault(), t.stopPropagation(), ie._jQueryInterface.call(Et(this), "toggle")
        }).on(Ot.CLICK_DATA_API, Bt, function(t) {
            t.stopPropagation()
        }), Et.fn[Tt] = ie._jQueryInterface, Et.fn[Tt].Constructor = ie, Et.fn[Tt].noConflict = function() {
            return Et.fn[Tt] = Mt, ie._jQueryInterface
        }, ie),
        Xi = (ne = "modal", re = "." + (oe = "bs.modal"), ae = (se = e).fn[ne], le = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
        ...
        }, ue = "modal-scrollbar-measure", de = "modal-backdrop", fe = "modal-open", pe = "fade", ge = "show", me = ".modal-dialog", ve = '[data-toggle="modal"]', _e = '[data-dismiss="modal"]', be = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", ye = ".sticky-top", we = function() {
            function n(t, e) {
            ...
            return t.toggle = function(t) {
                ...
                if (!this._isTransitioning && !this._isShown) {
                    ...
                    var i = se.Event(ce.SHOW, {
                        relatedTarget: t
                    });
                    se(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), se(document.body).addClass(fe), this._setEscapeEvent(), this._setResizeEvent(), se(this._element).on(ce.CLICK_DISMISS, _e, function(t) {
                        return e.hide(t)
                ...
                if (t && t.preventDefault(), !this._isTransitioning && this._isShown) {
                    ...
                    if (se(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        ...
                        if (s && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), se(document).off(ce.FOCUSIN), se(this._element).removeClass(ge), se(this._element).off(ce.CLICK_DISMISS), se(this._dialog).off(ce.MOUSEDOWN_DISMISS), s) {
                            var n = f.getTransitionDurationFromElement(this._element);
                            se(this._element).one(f.TRANSITION_END, function(t) {
                ...
                se.removeData(this._element, oe), se(window, document, this._element, this._backdrop).off(re), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._scrollbarWidth = null
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, i && f.reflow(this._element), se(this._element).addClass(ge), this._config.focus && this._enforceFocus();

                function s() {
                    e._config.focus && e._element.focus(), e._isTransitioning = !1, se(e._element).trigger(n)
                }
                var n = se.Event(ce.SHOWN, {
                    relatedTarget: t
                });
                if (i) {
                ...
                var e = this;
                se(document).off(ce.FOCUSIN).on(ce.FOCUSIN, function(t) {
                    document !== t.target && e._element !== t.target && 0 === se(e._element).has(t.target).length && e._element.focus()
                })
            }, t._setEscapeEvent = function() {
                var e = this;
                this._isShown && this._config.keyboard ? se(this._element).on(ce.KEYDOWN_DISMISS, function(t) {
                    27 === t.which && (t.preventDefault(), e.hide())
                }) : this._isShown || se(this._element).off(ce.KEYDOWN_DISMISS)
            }, t._setResizeEvent = function() {
                var e = this;
                this._isShown ? se(window).on(ce.RESIZE, function(t) {
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = de, i && this._backdrop.classList.add(i), se(this._backdrop).appendTo(document.body), se(this._element).on(ce.CLICK_DISMISS, function(t) {
                            e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._element.focus() : e.hide())
                        }), i && f.reflow(this._backdrop), se(this._backdrop).addClass(ge), !t) return;
                    if (!i) return void t();
                ...
                if (this._isBodyOverflowing) {
                    ...
                    se(t).each(function(t, e) {
                        ...
                        se(e).data("padding-right", i).css("padding-right", parseFloat(s) + n._scrollbarWidth + "px")
                    }), se(e).each(function(t, e) {
                        var i = e.style.marginRight,
                            s = se(e).css("margin-right");
                        se(e).data("margin-right", i).css("margin-right", parseFloat(s) - n._scrollbarWidth + "px")
                    });
                    var i = document.body.style.paddingRight,
                        s = se(document.body).css("padding-right");
                    se(document.body).data("padding-right", i).css("padding-right", parseFloat(s) + this._scrollbarWidth + "px")
                }
            ...
            var o = se(e).one(ce.SHOW, function(t) {
                t.isDefaultPrevented() || o.one(ce.HIDDEN, function() {
                    se(i).is(":visible") && i.focus()
                })
            });
            we._jQueryInterface.call(se(e), n, this)
        }), se.fn[ne] = we._jQueryInterface, se.fn[ne].Constructor = we, se.fn[ne].noConflict = function() {
            return se.fn[ne] = ae, we._jQueryInterface
        }, we),
        Zi = (De = "tooltip", ke = "." + (xe = "bs.tooltip"), Ie = (Ce = e).fn[De], Se = "bs-tooltip", Ee = new RegExp("(^|\\s)" + Se + "\\S+", "g"), Pe = {
            animation: !0,
        ...
        }, Oe = "fade", ze = "show", He = ".tooltip-inner", Le = ".arrow", We = "hover", Re = "focus", $e = "click", je = "manual", qe = function() {
            function s(t, e) {
            ...
            return t.enable = function() {
                ...
                if (this._isEnabled)
                    if (t) {
                        ...
                        i || (i = new this.constructor(t.currentTarget, this._getDelegateConfig()), Ce(t.currentTarget).data(e, i)), i._activeTrigger.click = !i._activeTrigger.click, i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(null, i)
                    } else {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    Ce(s).data(this.constructor.DATA_KEY, this), Ce.contains(this.element.ownerDocument.documentElement, this.tip) || Ce(s).appendTo(a), Ce(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new c(this.element, s, {
                        placement: r,
                        modifiers: {
                            offset: {
                    ...
                    }), Ce(s).addClass(ze), "ontouchstart" in document.documentElement && Ce(document.body).children().on("mouseover", null, Ce.noop);
                    var l = function() {
                ...
                function e() {
                    i._hoverState !== Fe && s.parentNode && s.parentNode.removeChild(s), i._cleanTipClass(), i.element.removeAttribute("aria-describedby"), Ce(i.element).trigger(i.constructor.Event.HIDDEN), null !== i._popper && i._popper.destroy(), t && t()
                }
                var i = this,
                    s = this.getTipElement(),
                    n = Ce.Event(this.constructor.Event.HIDE);
                if (Ce(this.element).trigger(n), !n.isDefaultPrevented()) {
                    if (Ce(s).removeClass(ze), "ontouchstart" in document.documentElement && Ce(document.body).children().off("mouseover", null, Ce.noop), this._activeTrigger[$e] = !1, this._activeTrigger[Re] = !1, this._activeTrigger[We] = !1, Ce(this.tip).hasClass(Oe)) {
                ...
                this.config.trigger.split(" ").forEach(function(t) {
                    if ("click" === t) Ce(s.element).on(s.constructor.Event.CLICK, s.config.selector, function(t) {
                        return s.toggle(t)
                    });
                    else if (t !== je) {
                        ...
                        Ce(s.element).on(e, s.config.selector, function(t) {
                            return s._enter(t)
                        }).on(i, s.config.selector, function(t) {
                            return s._leave(t)
                        })
                    }
                    Ce(s.element).closest(".modal").on("hide.bs.modal", function() {
                        return s.hide()
                    })
                ...
                var i = this.constructor.DATA_KEY;
                (e = e || Ce(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), Ce(t.currentTarget).data(i, e)), t && (e._activeTrigger["focusout" === t.type ? Re : We] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = Me, e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function() {
                ...
                return "number" == typeof(t = l({}, this.constructor.Default, Ce(this.element).data(), "object" == typeof t && t ? t : {})).delay && (t.delay = {
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), f.typeCheckConfig(De, t, this.constructor.DefaultType), t
        ...
        Gi = (Ye = "popover", Ke = "." + (Ue = "bs.popover"), Qe = (Be = e).fn[Ye], Ve = "bs-popover", Xe = new RegExp("(^|\\s)" + Ve + "\\S+", "g"), Ze = l({}, Zi.Default, {
            placement: "right",
            trigger: "click",
            content: "",
        ...
        }), Je = "fade", ei = ".popover-header", ii = ".popover-body", si = {
            HIDE: "hide" + Ke,
            HIDDEN: "hidden" + Ke,
            SHOW: (ti = "show") + Ke,
            SHOWN: "shown" + Ke,
        ...
        }(Zi), Be.fn[Ye] = ni._jQueryInterface, Be.fn[Ye].Constructor = ni, Be.fn[Ye].noConflict = function() {
            return Be.fn[Ye] = Qe, ni._jQueryInterface
        }, ni),
        Ji = (ri = "scrollspy", li = "." + (ai = "bs.scrollspy"), hi = (oi = e).fn[ri], ci = {
            offset: 10,
            method: "auto",
            target: ""
        }, ui = {
        ...
        }, fi = "dropdown-item", pi = "active", gi = '[data-spy="scroll"]', mi = ".active", vi = ".nav, .list-group", _i = ".nav-link", bi = ".nav-item", yi = ".list-group-item", wi = ".dropdown", Ci = ".dropdown-item", Di = ".dropdown-toggle", xi = "offset", ki = "position", Ii = function() {
            function i(t, e) {
                var i = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + _i + "," + this._config.target + " " + yi + "," + this._config.target + " " + Ci, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, oi(this._scrollElement).on(di.SCROLL, function(t) {
                    return i._process(t)
            ...
            return t.refresh = function() {
                ...
                i.hasClass(fi) ? (i.closest(wi).find(Di).addClass(pi), i.addClass(pi)) : (i.addClass(pi), i.parents(vi).prev(_i + ", " + yi).addClass(pi), i.parents(vi).prev(bi).children(_i).addClass(pi)), oi(this._scrollElement).trigger(di.ACTIVATE, {
                    relatedTarget: e
                })
            }, t._clear = function() {
        ...
        }), oi.fn[ri] = Ii._jQueryInterface, oi.fn[ri].Constructor = Ii, oi.fn[ri].noConflict = function() {
            return oi.fn[ri] = hi, Ii._jQueryInterface
        }, Ii),
        ts = (Ti = "." + (Ei = "bs.tab"), Ai = (Si = e).fn.tab, Pi = {
            HIDE: "hide" + Ti,
            HIDDEN: "hidden" + Ti,
            SHOW: "show" + Ti,
            SHOWN: "shown" + Ti,
            CLICK_DATA_API: "click" + Ti + ".data-api"
        }, Fi = "dropdown-menu", Mi = "active", Ni = "disabled", Oi = "fade", zi = "show", Hi = ".dropdown", Li = ".nav, .list-group", Wi = ".active", Ri = "> li > .active", $i = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', ji = ".dropdown-toggle", qi = "> .dropdown-menu .active", Bi = function() {
            function s(t) {
                this._element = t
            }
            var t = s.prototype;
        ...
        }), Si.fn.tab = Bi._jQueryInterface, Si.fn.tab.Constructor = Bi, Si.fn.tab.noConflict = function() {
    ...
    }(e), t.Util = f, t.Alert = Yi, t.Button = Ui, t.Carousel = Ki, t.Collapse = Qi, t.Dropdown = Vi, t.Modal = Xi, t.Popover = Gi, t.Scrollspy = Ji, t.Tab = ts, t.Tooltip = Zi, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}),
function(a) {
    ...
    b.widget("ui.draggable", b.ui.mouse, {
        ...
        drag: function(t, e) {
            for (var i = b(this).data("draggable"), s = i.options, n = s.snapTolerance, o = e.offset.left, r = o + i.helperProportions.width, a = e.offset.top, l = a + i.helperProportions.height, h = i.snapElements.length - 1; 0 <= h; h--) {
                ...
                if (c - n < o && o < u + n && d - n < a && a < f + n || c - n < o && o < u + n && d - n < l && l < f + n || c - n < r && r < u + n && d - n < a && a < f + n || c - n < r && r < u + n && d - n < l && l < f + n) {
                    if ("inner" != s.snapMode) {
                    ...
                    }!i.snapElements[h].snapping && (p || g || m || v || _) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, b.extend(i._uiHash(), {
...
function(f) {
    f.widget("ui.droppable", {
        ...
        drag: function(n, o) {
            n.options.refreshPositions && f.ui.ddmanager.prepareOffsets(n, o), f.each(f.ui.ddmanager.droppables[n.options.scope] || [], function() {
...
function(p) {
    p.widget("ui.resizable", p.ui.mouse, {
        ...
        _mouseStart: function(t) {
            ...
            e.containment && (n += p(e.containment).scrollLeft() || 0, o += p(e.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
                left: n,
                top: o
        ...
        _mouseStop: function(t) {
            ...
            if (this._helper) {
                ...
                e.animate || this.element.css(p.extend(a, {
                    top: h,
                    left: l
        ...
        _updateVirtualBoundaries: function(t) {
            ...
            o = {
                minWidth: f(r.minWidth) ? r.minWidth : 0,
                maxWidth: f(r.maxWidth) ? r.maxWidth : 1 / 0,
                minHeight: f(r.minHeight) ? r.minHeight : 0,
                maxHeight: f(r.maxHeight) ? r.maxHeight : 1 / 0
        ...
        start: function(t, e) {
            ...
            "object" != typeof s.alsoResize || s.alsoResize.parentNode ? i(s.alsoResize) : s.alsoResize.length ? (s.alsoResize = s.alsoResize[0], i(s.alsoResize)) : p.each(s.alsoResize, function(t) {
                i(t)
            })
        },
        resize: function(t, o) {
            ...
            "object" != typeof s.alsoResize || s.alsoResize.nodeType ? i(s.alsoResize) : p.each(s.alsoResize, function(t, e) {
                i(t, e)
            })
        },
        stop: function(t, e) {
        ...
        start: function(t, e) {
            ...
            if (r)
                if (i.containerElement = p(r), /document/.test(o) || o == document) i.containerOffset = {
                    left: 0,
                    top: 0
                }, i.containerPosition = {
                    left: 0,
        ...
        stop: function(t, e) {
            ...
            i._helper && !s.animate && /relative/.test(r.css("position")) && p(this).css({
                left: l.left - o.left - n.left,
                width: h,
                height: c
            }), i._helper && !s.animate && /static/.test(r.css("position")) && p(this).css({
                left: l.left - o.left - n.left,
                width: h,
                height: c
            })
...
function(d) {
    d.widget("ui.sortable", d.ui.mouse, {
        ...
        h.effects.animateClass = function(o, r, a, l) {
            ...
            easeInOutElastic: function(t, e, i, s, n) {
                ...
                return e < 1 ? -.5 * a * Math.pow(2, 10 * --e) * Math.sin(2 * (e * n - o) * Math.PI / r) + i : a * Math.pow(2, -10 * --e) * Math.sin(2 * (e * n - o) * Math.PI / r) * .5 + s + i
            },
        ...
        p.effects.bounce = function(f) {
            return this.queue(function() {
                ...
                "show" == i && t.css("opacity", 0).css(a, "pos" == l ? -n : n), "hide" == i && (n /= 2 * o), "hide" != i && o--, "show" == i && ((u = {
                    opacity: 1
                })[a] = ("pos" == l ? "+=" : "-=") + n, t.animate(u, r / 2, f.options.easing), n /= 2, o--);
                for (var h = 0; h < o; h++) {
                    var c = {};
                ...
                if ("hide" == i) {
                    ...
                    (u = {
                        opacity: 0
                    })[a] = ("pos" == l ? "-=" : "+=") + n, t.animate(u, r / 2, f.options.easing, function() {
                        t.hide(), p.effects.restore(t, e), p.effects.removeWrapper(t), f.callback && f.callback.apply(this, arguments)
                    })
                } else {
                    var d;
                    c = {};
                    (d = {})[a] = ("pos" == l ? "-=" : "+=") + n, c[a] = ("pos" == l ? "+=" : "-=") + n, t.animate(d, r / 2, f.options.easing).animate(c, r / 2, f.options.easing, function() {
    ...
    function(p) {
        p.effects.fold = function(f) {
            return this.queue(function() {
                ...
                var r = p.effects.createWrapper(t).css({
                        overflow: "hidden"
                    }),
                    a = "show" == i != n,
                ...
                var u = {},
                    d = {};
                u[l[0]] = "show" == i ? h[0] : s, d[l[1]] = "show" == i ? h[1] : 0, r.animate(u, o, f.options.easing).animate(d, o, f.options.easing, function() {
    ...
    function(g) {
        g.effects.puff = function(o) {
            ...
            return this.queue(function() {
                ...
                "box" != h && "both" != h || (f.from.y != f.to.y && (e = e.concat(o), t.from = g.effects.setTransition(t, o, f.from.y, t.from), t.to = g.effects.setTransition(t, o, f.to.y, t.to)), f.from.x != f.to.x && (e = e.concat(r), t.from = g.effects.setTransition(t, r, f.from.x, t.from), t.to = g.effects.setTransition(t, r, f.to.x, t.to))), "content" != h && "both" != h || f.from.y == f.to.y || (e = e.concat(n), t.from = g.effects.setTransition(t, n, f.from.y, t.from), t.to = g.effects.setTransition(t, n, f.to.y, t.to)), g.effects.save(t, l ? e : i), t.show(), g.effects.createWrapper(t), t.css("overflow", "hidden").css(t.from), "content" != h && "both" != h || (o = o.concat(["marginTop", "marginBottom"]).concat(n), r = r.concat(["marginLeft", "marginRight"]), s = e.concat(o).concat(r), t.find("*[width]").each(function() {
                    var t = g(this);
                    ...
                    t.from = {
                        ...
                        height: e * f.to.y,
                        width: i * f.to.x
                    }, f.from.y != f.to.y && (t.from = g.effects.setTransition(t, o, f.from.y, t.from), t.to = g.effects.setTransition(t, o, f.to.y, t.to)), f.from.x != f.to.x && (t.from = g.effects.setTransition(t, r, f.from.x, t.from), t.to = g.effects.setTransition(t, r, f.to.x, t.to)), t.css(t.from), t.animate(t.to, p.duration, p.options.easing, function() {
        ...
        o.widget("ui.button", {
            ...
            _create: function() {
                ...
                null === i.label && (i.label = this.buttonElement.html()), this.buttonElement.addClass(d).attr("role", "button").bind("mouseenter.button", function() {
                    ...
                    o(this).addClass("ui-state-active"), l = this, o(document).one("mouseup", function() {
                        l = null
                    })
            ...
            destroy: function() {
                this.element.removeClass("ui-helper-hidden-accessible"), this.buttonElement.removeClass(d + " ui-state-hover ui-state-active  " + f).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()), this.hasTitle || this.buttonElement.removeAttr("title"), o.Widget.prototype.destroy.call(this)
            },
            _setOption: function(t, e) {
        ...
        $.extend(Datepicker.prototype, {
                ...
                if ("input" != (t = t.target || t).nodeName.toLowerCase() && (t = $("input", t.parentNode)[0]), !$.datepicker._isDisabledDatepicker(t) && $.datepicker._lastInput != t) {
                    ...
                    if (!1 !== s) {
                        ...
                        if ($.datepicker._pos = null, i.dpDiv.empty(), i.dpDiv.css({
                            ...
                            i.dpDiv.zIndex($(t).zIndex() + 1), $.datepicker._datepickerShowing = !0, $.effects && $.effects[a] ? i.dpDiv.show(a, $.datepicker._get(i, "showOptions"), l, r) : i.dpDiv[a || "show"](a ? l : null, r), a && l || r(), i.input.is(":visible") && !i.input.is(":disabled") && i.input.focus(), $.datepicker._curInst = i
                        }
                    }
                }
            },
            ...
            _hideDatepicker: function(t) {
                ...
                if (e && (!t || e == $.data(t, PROP_NAME)) && this._datepickerShowing) {
                    ...
                    $.effects && $.effects[s] ? e.dpDiv.hide(s, $.datepicker._get(e, "showOptions"), n, i) : e.dpDiv["slideDown" == s ? "slideUp" : "fadeIn" == s ? "fadeOut" : "hide"](s ? n : null, i), s || i(), this._datepickerShowing = !1;
            ...
            parseDate: function(i, o, t) {
                ...
                for (var l = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, h = (t ? t.dayNames : null) || this._defaults.dayNames, c = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, u = (t ? t.monthNames : null) || this._defaults.monthNames, d = -1, f = -1, p = -1, g = -1, m = !1, v = 0, _ = 0; _ < i.length; _++)
            ...
            _generateHTML: function(t) {
                ...
                for (var k = this._get(t, "showWeek"), I = this._get(t, "dayNames"), S = (this._get(t, "dayNamesShort"), this._get(t, "dayNamesMin")), E = this._get(t, "monthNames"), T = this._get(t, "monthNamesShort"), A = this._get(t, "beforeShowDay"), P = this._get(t, "showOtherMonths"), F = this._get(t, "selectOtherMonths"), M = (this._get(t, "calculateWeek") || this.iso8601Week, this._getDefaultDate(t)), N = "", O = 0; O < r[0]; O++) {
                    ...
                    for (var H = 0; H < r[1]; H++) {
                        ...
                        R += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + W + '">' + (/all|left/.test(W) && 0 == O ? i ? b : v : "") + (/all|right/.test(W) && 0 == O ? i ? v : b : "") + this._generateMonthYearHeader(t, f, p, u, d, 0 < O || 0 < H, E, T) + '</div><table class="ui-datepicker-calendar"><thead><tr>';
                        ...
                        for (var V = this._daylightSavingAdjust(new Date(p, f, 1 - U)), X = 0; X < Q; X++) {
                            ...
                            for (q = 0; q < 7; q++) {
                                ...
                                Z += '<td class="' + (5 <= (q + x + 6) % 7 ? " ui-datepicker-week-end" : "") + (J ? " ui-datepicker-other-month" : "") + (V.getTime() == L.getTime() && f == t.selectedMonth && t._keyEvent || M.getTime() == V.getTime() && M.getTime() == L.getTime() ? " " + this._dayOverClass : "") + (tt ? " " + this._unselectableClass + " ui-state-disabled" : "") + (J && !P ? "" : " " + G[1] + (V.getTime() == c.getTime() ? " " + this._currentClass : "") + (V.getTime() == e.getTime() ? " ui-datepicker-today" : "")) + '"' + (J && !P || !G[2] ? "" : ' title="' + G[2] + '"') + (tt ? "" : ' data-handler="selectDay" data-event="click" data-month="' + V.getMonth() + '" data-year="' + V.getFullYear() + '"') + ">" + (J && !P ? "&#xa0;" : tt ? '<span class="ui-state-default">' + V.getDate() + "</span>" : '<a class="ui-state-default' + (V.getTime() == e.getTime() ? " ui-state-highlight" : "") + (V.getTime() == c.getTime() ? " ui-state-active" : "") + (J ? " ui-priority-secondary" : "") + '" href="#">' + V.getDate() + "</a>") + "</td>", V.setDate(V.getDate() + 1), V = this._daylightSavingAdjust(V)
                            }
                            R += Z + "</tr>"
                        }
    ...
    function(g) {
        ...
        g.fn.position = function(h) {
                ...
                return d = 9 === e.nodeType ? (c = t.width(), u = t.height(), {
                    top: 0,
                    left: 0
                    ...
                    top: h.of.pageY,
                    left: h.of.pageX
                }) : (c = t.outerWidth(), u = t.outerHeight(), t.offset()), g.each(["my", "at"], function() {
                    var t = (h[this] || "").split(" ");
                    1 === t.length && (t = i.test(t[0]) ? t.concat([m]) : s.test(t[0]) ? [m].concat(t) : [m, m]), t[0] = i.test(t[0]) ? t[0] : m, t[1] = s.test(t[1]) ? t[1] : m, h[this] = t
                }), 1 === f.length && (f[1] = f[0]), p[0] = parseInt(p[0], 10) || 0, 1 === p.length && (p[1] = p[0]), p[1] = parseInt(p[1], 10) || 0, "right" === h.at[0] ? d.left += c : h.at[0] === m && (d.left += c / 2), "bottom" === h.at[1] ? d.top += u : h.at[1] === m && (d.top += u / 2), d.left += p[0], d.top += p[1], this.each(function() {
                    var i, t = g(this),
                        s = t.outerWidth(),
                        n = t.outerHeight(),
                    ...
                    "right" === h.my[0] ? l.left -= s : h.my[0] === m && (l.left -= s / 2), "bottom" === h.my[1] ? l.top -= n : h.my[1] === m && (l.top -= n / 2), v.fractions || (l.left = Math.round(l.left), l.top = Math.round(l.top)), i = {
                        ...
                        g.ui.position[f[t]] && g.ui.position[f[t]][e](l, {
                            targetWidth: c,
                            targetHeight: u,
                            elemWidth: s,
                            elemHeight: n,
    ...
    function(f) {
        ...
        f.widget("ui.tabs", {
            ...
            _tabify: function(t) {
                ...
                this.list = this.element.find("ol,ul").eq(0), this.lis = f(" > li:has(a[href])", this.list), this.anchors = this.lis.map(function() {
                    ...
                    if (n && (n === location.toString().split("#")[0] || (i = f("base")[0]) && n === i.href) && (s = e.hash, e.href = s), h.test(s)) a.panels = a.panels.add(a.element.find(a._sanitizeSelector(s)));
                        ...
                        r.length || (r = f(l.panelTemplate).attr("id", o).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(a.panels[t - 1] || a.list)).data("destroy.tabs", !0), a.panels = a.panels.add(r)
                ...
                }), "number" != typeof l.selected && l.cookie && (l.selected = parseInt(a._cookie(), 10)), "number" != typeof l.selected && this.lis.filter(".ui-tabs-selected").length && (l.selected = this.lis.index(this.lis.filter(".ui-tabs-selected"))), l.selected = l.selected || (this.lis.length ? 0 : -1)) : null === l.selected && (l.selected = -1), l.selected = 0 <= l.selected && this.anchors[l.selected] || l.selected < 0 ? l.selected : 0, l.disabled = f.unique(l.disabled.concat(f.map(this.lis.filter(".ui-state-disabled"), function(t, e) {
                    return a.lis.index(t)
                }))).sort(), -1 != f.inArray(l.selected, l.disabled) && l.disabled.splice(f.inArray(l.selected, l.disabled), 1), this.panels.addClass("ui-tabs-hide"), this.lis.removeClass("ui-tabs-selected ui-state-active"), 0 <= l.selected && this.anchors.length && (a.element.find(a._sanitizeSelector(a.anchors[l.selected].hash)).removeClass("ui-tabs-hide"), this.lis.eq(l.selected).addClass("ui-tabs-selected ui-state-active"), a.element.queue("tabs", function() {
                ...
                this.anchors.bind(l.event + ".tabs", function() {
                    ...
                    i.length && a.element.queue("tabs", function() {
                        ...
                        u(t, s)
                    }), a.load(a.anchors.index(this)), f.browser.msie && this.blur()
            ...
            add: function(t, e, i) {
                ...
                return a.length || (a = f(n.panelTemplate).attr("id", r).data("destroy.tabs", !0)), a.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide"), i >= this.lis.length ? (o.appendTo(this.list), a.appendTo(this.list[0].parentNode)) : (o.insertBefore(this.lis[i]), a.insertBefore(this.panels[i])), n.disabled = f.map(n.disabled, function(t, e) {
                    return i <= t ? ++t : t
            ...
            load: function(s) {
                ...
                if (this.abort(), t && (0 === this.element.queue("tabs").length || !f.data(r, "cache.tabs"))) {
                    ...
                    return this.xhr = f.ajax(f.extend({}, o.ajaxOptions, {
                        url: t,
                        success: function(t, e) {
        ...
        u.each("branch form header step wrapper".split(" "), function() {
            ...
            _create: function() {
                var t, e, i = this,
                    ...
                    wizard: n.addClass(f)
                }, o.attr("id") || o.attr("id", f + "-" + ++r), i.elements.forward.click(function(t) {
            ...
            destroy: function() {
                var t = this.elements;
                this._trigger("beforeDestroy", null, this.state()) && (this.element.removeClass(f), t.form.removeClass(a.form), t.header.removeClass(a.header), t.steps.show().removeClass(a.step), t.stepsWrapper.removeClass(a.wrapper), t.branches.removeClass(a.branch), u.Widget.prototype.destroy.call(this), this._trigger("afterDestroy"))
            },
            form: function() {
        ...
        h.extend(h.fn, {
            ...
            attributeRules: function(t) {
                ...
                for (var n in h.validator.methods) {
                    var o;
                    o = "required" === n ? ("" === (o = i.get(0).getAttribute(n)) && (o = !0), !!o) : i.attr(n), /min|max/.test(n) && (null === s || /number|range|text/.test(s)) && (o = Number(o)), o ? e[n] = o : s === n && "range" !== s && (e[n] = !0)
                }
